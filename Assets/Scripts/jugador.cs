...
public class jugador : MonoBehaviour
{
    ...
    void Update()
    {
      ...
      // Debug.Log((int)transform.forward.x == 1);
        ...
        if (moves == 1)
        {
            ...
            direccion = new Vector3(gameObject.transform.forward.x, gameObject.transform.forward.y, gameObject.transform.forward.z-(dir.z-offsetZ) );
   ...
   //         texto.text = "FALSO";
            ...
            direccion = new Vector3(gameObject.transform.forward.x + dir.x, gameObject.transform.forward.y, gameObject.transform.forward.z);
            transform.Translate(direccion * Time.deltaTime * velPersonaje, Space.World);
